...
function clsObject:New ( _Obj )
	local o = {}
	if not _Obj then return "Expected table" end
...
function clsBase:New( _Obj )
	local o
	if not _Obj then return "Expected table {Pos, Parent}" end
	o = clsObject:New( {
		--UniqId
		--TimeUpdated
		["Type"] = "Base",
...
function clsFarm:New( _Obj )
	local o
	if not _Obj then return "Expected table {Pos, Size, Parent}" end
	o = clsObject:New( {
		--UniqId
		--TimeUpdated
		["Type"] = "Farm",
...
function clsInventory:New( _Obj )
	local o
	if not _Obj then return "Expected table { Extra, Pos, Parent }" end
	o = clsObject:New( {
		--UniqId
		--TimeUpdated
		["Type"] = "Inventory",
...
function clsBag:New( _Obj )
	local o
	if not _Obj then return "Expected table {Extra, Pos, Size, Parent}" end
	o = clsObject:New( {
		--UniqId
		--TimeUpdated
		["Type"] = "Bag",
