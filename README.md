...
There will be "Official RoCoWa tournament" once every month where 16 participants will compete for a prize by improving and upgrading his colony's code on-the-fly in real-time. The AI above will be used as a default code that every participant will start with.
...
```lua
-- Credits to RoCoWa @ github.com/Akuukis/TurtleColorWars
```

### Coroutine Manager (~ 450 lines, located in paralel.lua)
